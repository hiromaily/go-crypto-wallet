# PostgreSQL Sign Schema Migrations
...
ls -la migrations/postgresql_sign/
```
...
- Environment: `local_postgresql_sign`
- Database URL: `postgres://postgres:postgres@localhost:5432/sign?sslmode=disable`
- Schema source: `file://schemas/sign.hcl`
- Dev database: `docker://postgres/18/sign`
