...
CREATE TABLE `btc_tx` (
  ...
  `signed_hex_tx`       TEXT COLLATE utf8_unicode_ci NOT NULL COMMENT 'HEX string for signed transaction',
  `sent_hash_tx`        TEXT COLLATE utf8_unicode_ci NOT NULL COMMENT 'Hash for sent transaction',
