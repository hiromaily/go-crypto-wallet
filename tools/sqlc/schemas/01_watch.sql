...
CREATE TABLE address (
  ...
  KEY idx_coin (coin)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='table for account pubkey';
...
CREATE TABLE btc_tx (
  ...
  KEY idx_coin (coin)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='table for btc transaction info';
...
CREATE TABLE btc_tx_input (
  ...
  PRIMARY KEY (id),
  KEY idx_tx_id (tx_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='table for input transaction';
...
CREATE TABLE btc_tx_output (
  ...
  PRIMARY KEY (id),
  KEY idx_tx_id (tx_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='table for output transaction';
...
CREATE TABLE eth_detail_tx (
  ...
  KEY idx_txid (tx_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='table for eth transaction detail';
...
CREATE TABLE payment_request (
  ...
  PRIMARY KEY (id),
  KEY idx_coin (coin)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='table for payment request';
...
CREATE TABLE tx (
  ...
  KEY idx_action (action),
  KEY idx_coin (coin)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='table for eth transaction info';
...
CREATE TABLE xrp_detail_tx (
  ...
  KEY idx_sender_account (sender_account),
  KEY idx_txid (tx_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='table for xrp transaction detail';
