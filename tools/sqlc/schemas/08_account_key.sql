...
CREATE TABLE `account_key` (
  ...
  `taproot_address`         VARCHAR(255) NULL DEFAULT NULL COMMENT 'taproot address (BIP86)',
  ...
  `redeem_script`           VARCHAR(1000) DEFAULT '' NOT NULL COMMENT'redeedScript after multisig address generated',
