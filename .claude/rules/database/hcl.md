...
| Path                               | Description                                   |
| ---------------------------------- | --------------------------------------------- |
| `tools/atlas/schemas/{db_dialect}` | Database schema definitions (source of truth) |
...
| File                                          | Description                    |
| --------------------------------------------- | ------------------------------ |
| `tools/atlas/schemas/{db_dialect}/watch.hcl`  | Watch wallet schema (online)   |
| `tools/atlas/schemas/{db_dialect}/keygen.hcl` | Keygen wallet schema (offline) |
| `tools/atlas/schemas/{db_dialect}/sign.hcl`   | Sign wallet schema (offline)   |
