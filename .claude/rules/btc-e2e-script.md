...
# Usage: ./scripts/operation/btc/e2e/e2e-{pattern}.sh [OPTIONS]
# Options:
...
```makefile
.PHONY: btc-e2e-{pattern}-reset
btc-e2e-{pattern}-reset:
 ./scripts/operation/btc/e2e/e2e-{pattern}.sh --reset

.PHONY: btc-e2e-{pattern}
btc-e2e-{pattern}:
 ./scripts/operation/btc/e2e/e2e-{pattern}.sh

.PHONY: btc-e2e-{pattern}-verbose
btc-e2e-{pattern}-verbose:
 ./scripts/operation/btc/e2e/e2e-{pattern}.sh --verbose

.PHONY: btc-e2e-{pattern}-ci
btc-e2e-{pattern}-ci:
 ./scripts/operation/btc/e2e/e2e-{pattern}.sh --non-interactive

.PHONY: btc-e2e-{pattern}-cleanup
btc-e2e-{pattern}-cleanup:
 ./scripts/operation/btc/e2e/e2e-{pattern}.sh --cleanup
```
