...
- Run `npm install` or `yarn` — use `bun install`
- Use `truffle` or `hardhat` — this project uses Foundry only
- Edit files in `out/`, `lib/`, or `node_modules/` — these are generated/installed
- Commit `lib/`, `out/`, `node_modules/`, or `.env`
