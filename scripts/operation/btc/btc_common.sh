...
# SQLite schema file location (E2E composite schemas)
# These are generated by `make generate-e2e-sqlite-schemas` and include all
# tables each wallet needs at runtime (sign gets shared tables from keygen).
