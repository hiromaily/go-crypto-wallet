...
# Format: watch-e2e-p8-{timestamp}.db, keygen-e2e-p8-{timestamp}.db, etc.
export E2E_PATTERN="p8"
...
Transaction Pattern: P2SH-P2WSH 3-of-3 Multisig (Address: 2... in Regtest)
EOF
}
