...
# Format: watch-e2e-p4-{timestamp}.db, keygen-e2e-p4-{timestamp}.db, etc.
...
# Pattern 4 requires: address_type: "p2sh-segwit"
...
Transaction Pattern: P2SH-P2WSH 2-of-3 Multisig (Address: 2... in Regtest)
EOF
}
