...
# This script automates the complete Bitcoin workflow for 2-of-3 multisig P2WSH transactions
...
# Format: watch-e2e-p6-{timestamp}.db, keygen-e2e-p6-{timestamp}.db, etc.
export E2E_PATTERN="p6"
...
Transaction Pattern: P2WSH 2-of-3 Multisig (Address: bcrt1q... in Regtest)
EOF
}
