...
# This script automates the complete Bitcoin workflow for 3-of-3 multisig P2WSH (Native SegWit) transactions
...
#   - Descriptor: wsh(sortedmulti(3,[fingerprint/84'/1'/1']xpub1.../0/*,xpub2.../0/*,xpub3.../0/*))
#
# Required Config Settings:
#   - config/wallet/btc_watch.yaml:  address_type: "bech32"
#   - config/wallet/btc_keygen.yaml: address_type: "bech32"
#   - config/wallet/btc_sign1.yaml:  address_type: "bech32"
#   - config/wallet/btc_sign2.yaml:  address_type: "bech32"
...
# Use 3-of-3 multisig account configuration for Pattern 7
...
#
# Pattern 7 (P2WSH Native SegWit 3-of-3 Multisig) requires:
#   - address_type: "bech32" (derives key_type: bip84 automatically)
...
check_prerequisites() {
	...
	# Check CLI commands (watch, keygen, sign1, sign2 for 3-of-3 multisig)
...
setup_infrastructure() {
	...
	# Start Bitcoin nodes (watch, keygen, sign1, sign2 for 3-of-3)
...
multisig_setup_phase() {
	...
	# Pattern 7 uses 3-of-3 multisig with P2WSH (BIP84 Native SegWit)
	...
	log_info "Note: Pattern 7 uses 3-of-3 multisig with P2WSH (BIP84 Native SegWit)"
	...
	# For P2WSH (3-of-3), we use the descriptor at index 0
...
generate_test_utxos() {
	...
	# Verify address format (should start with 'bcrt1q' for regtest P2WSH)
	if [[ ! "$payment_address" =~ ^bcrt1q ]]; then
		log_warn "Warning: Expected P2WSH address starting with 'bcrt1q', got: $payment_address"
...
This script automates the complete Bitcoin workflow for 3-of-3 multisig P2WSH
(Native SegWit) transactions. It serves as a regression test tool to verify that
the Bitcoin 3-of-3 multisig Native SegWit workflow functions correctly after code changes.
...
ensuring that P2WSH Native SegWit addresses are properly handled.
...
Transaction Pattern Details:
  - Address Type: P2WSH (BIP84 Native SegWit)
  - Address Format: bcrt1q... (Regtest - 62 chars for P2WSH)
  - Signature Requirement: 3-of-3 (all 3 signatures required)
  - Descriptor: wsh(sortedmulti(3, xpub1, xpub2, xpub3))
  - Most efficient 3-of-3 multisig format (no P2SH wrapper)
  - Highest security (all keys must sign)
...
main() {
	...
	log_info "  ✓ P2WSH Native SegWit 3-of-3 multisig addresses created"
	...
	log_info "  • P2WSH (BIP84 Native SegWit) 3-of-3 multisig"
	...
	log_info "  • Most efficient 3-of-3 multisig format (no P2SH wrapper overhead)"
	log_info "  • Highest security (no single point of failure)"
	echo ""
	log_info "You can now use the wallet system for Bitcoin 3-of-3 multisig Native SegWit operations"
