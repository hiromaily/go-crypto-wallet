...
file_pubkey_deposit=$(keygen export address -account deposit)
...
#sign import address -account deposit -file ./data/pubkey/deposit_1_1586831083436291000.csv
sign import address -account deposit -file ${file_pubkey_deposit##*\[fileName\]: }
...
file_multisig_deposit=$(sign export multisig -account deposit)
...
#keygen import multisig -account deposit -file ./data/pubkey/deposit_2_1586924056349877000.csv
keygen import multisig -account deposit -file ${file_multisig_deposit##*\[fileName\]: }
...
file_multisig_deposit=$(keygen export multisig -account deposit)
...
wallet import address -account deposit -file ${file_multisig_deposit##*\[fileName\]: }
