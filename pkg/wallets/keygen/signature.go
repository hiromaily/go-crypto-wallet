...
func (w *Keygen) SignatureFromFile(filePath string) (string, bool, string, error) {
	//TODO:remove it
...
// signatureByHex 署名する
// オフラインで使うことを想定
func (w *Keygen) signatureByHex(hex, encodedAddrsPrevs string, actionType enum.ActionType) (string, bool, string, error) {
	// Hexからトランザクションを取得
