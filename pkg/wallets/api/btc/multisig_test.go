...
//
//	//TODO: Multisigアドレス作成
//	resAddr, err := wlt.BTC.AddMultisigAddress(2, []string{"2N7ZwUXpo841GZDpxLGFqrhr1xwMzTba7ZP", "2NAm558FWpiaJQLz838vbzBPpqmKxyeyxsu"}, "multi01", ctype.AddrTypeLegacy)
//	if err != nil {
//		t.Fatal(err)
//	}
...
//
//	resAddr, err = wlt.BTC.AddMultisigAddress(2, []string{"2N7ZwUXpo841GZDpxLGFqrhr1xwMzTba7ZP", "2NAm558FWpiaJQLz838vbzBPpqmKxyeyxsu"}, "multi02", ctype.AddrTypeP2shSegwit)
//	if err != nil {
//		t.Fatal(err)
//	}
//	t.Logf("multisig address: %s, redeemScript: %s", resAddr.Address, resAddr.RedeemScript)
