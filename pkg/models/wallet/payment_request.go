...
type PaymentRequest struct {
	...
	AccountFrom string        `boil:"account_from" json:"account_from" toml:"account_from" yaml:"account_from"`
...
var PaymentRequestWhere = struct {
	...
	AddressFrom: whereHelperstring{field: "`payment_request`.`address_from`"},
	AccountFrom: whereHelperstring{field: "`payment_request`.`account_from`"},
	AddressTo:   whereHelperstring{field: "`payment_request`.`address_to`"},
...
var (
	paymentRequestAllColumns            = []string{"id", "payment_id", "address_from", "account_from", "address_to", "amount", "is_done", "updated_at"}
	paymentRequestColumnsWithoutDefault = []string{"payment_id", "address_from", "account_from", "address_to", "amount"}
