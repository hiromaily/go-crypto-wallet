...
var AuthAccountKeyTableColumns = struct {
	ID                 string
	Coin               string
	AuthAccount        string
	P2PKHAddress       string
	...
	ID:                 "auth_account_key.id",
	Coin:               "auth_account_key.coin",
	AuthAccount:        "auth_account_key.auth_account",
	P2PKHAddress:       "auth_account_key.p2pkh_address",
	P2SHSegwitAddress:  "auth_account_key.p2sh_segwit_address",
	Bech32Address:      "auth_account_key.bech32_address",
	FullPublicKey:      "auth_account_key.full_public_key",
	MultisigAddress:    "auth_account_key.multisig_address",
	RedeemScript:       "auth_account_key.redeem_script",
	WalletImportFormat: "auth_account_key.wallet_import_format",
	Idx:                "auth_account_key.idx",
	AddrStatus:         "auth_account_key.addr_status",
	UpdatedAt:          "auth_account_key.updated_at",
}
...
var (
	...
	authAccountKeyGeneratedColumns      = []string{}
)

type (
	// AuthAccountKeySlice is an alias for a slice of pointers to AuthAccountKey.
	// This should almost always be used instead of []AuthAccountKey.
