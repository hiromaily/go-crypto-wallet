...
var AuthFullpubkeyTableColumns = struct {
	ID            string
	Coin          string
	AuthAccount   string
	FullPublicKey string
	...
	ID:            "auth_fullpubkey.id",
	Coin:          "auth_fullpubkey.coin",
	AuthAccount:   "auth_fullpubkey.auth_account",
	FullPublicKey: "auth_fullpubkey.full_public_key",
	UpdatedAt:     "auth_fullpubkey.updated_at",
}
...
var (
	...
	authFullpubkeyGeneratedColumns      = []string{}
)

type (
	// AuthFullpubkeySlice is an alias for a slice of pointers to AuthFullpubkey.
	// This should almost always be used instead of []AuthFullpubkey.
