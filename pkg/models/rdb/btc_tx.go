...
type BTCTX struct { // transaction ID
...
var BTCTXTableColumns = struct {
	...
	ID:                "btc_tx.id",
	Coin:              "btc_tx.coin",
	Action:            "btc_tx.action",
	UnsignedHexTX:     "btc_tx.unsigned_hex_tx",
	SignedHexTX:       "btc_tx.signed_hex_tx",
	SentHashTX:        "btc_tx.sent_hash_tx",
	TotalInputAmount:  "btc_tx.total_input_amount",
	TotalOutputAmount: "btc_tx.total_output_amount",
	Fee:               "btc_tx.fee",
	CurrentTXType:     "btc_tx.current_tx_type",
	UnsignedUpdatedAt: "btc_tx.unsigned_updated_at",
	SentUpdatedAt:     "btc_tx.sent_updated_at",
}
...
var (
	...
	btcTXGeneratedColumns      = []string{}
)

type (
	// BTCTXSlice is an alias for a slice of pointers to BTCTX.
	// This should almost always be used instead of []BTCTX.
	BTCTXSlice []*BTCTX
