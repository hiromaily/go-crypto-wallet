...
var AccountKeyTableColumns = struct {
	ID                 string
	Coin               string
	Account            string
	P2PKHAddress       string
	...
	ID:                 "account_key.id",
	Coin:               "account_key.coin",
	Account:            "account_key.account",
	P2PKHAddress:       "account_key.p2pkh_address",
	P2SHSegwitAddress:  "account_key.p2sh_segwit_address",
	Bech32Address:      "account_key.bech32_address",
	FullPublicKey:      "account_key.full_public_key",
	MultisigAddress:    "account_key.multisig_address",
	RedeemScript:       "account_key.redeem_script",
	WalletImportFormat: "account_key.wallet_import_format",
	Idx:                "account_key.idx",
	AddrStatus:         "account_key.addr_status",
	UpdatedAt:          "account_key.updated_at",
}
...
var (
	...
	accountKeyGeneratedColumns      = []string{}
)

type (
	// AccountKeySlice is an alias for a slice of pointers to AccountKey.
	// This should almost always be used instead of []AccountKey.
