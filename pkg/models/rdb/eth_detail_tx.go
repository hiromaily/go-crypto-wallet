...
var EthDetailTXWhere = struct {
	...
	UUID:              whereHelperstring{field: "`eth_detail_tx`.`uuid`"},
	CurrentTXType:     whereHelperint8{field: "`eth_detail_tx`.`current_tx_type`"},
	...
	UnsignedUpdatedAt: whereHelpernull_Time{field: "`eth_detail_tx`.`unsigned_updated_at`"},
	SentUpdatedAt:     whereHelpernull_Time{field: "`eth_detail_tx`.`sent_updated_at`"},
}
...
var (
	ethDetailTXAllColumns            = []string{"id", "tx_id", "uuid", "current_tx_type", "sender_account", "sender_address", "receiver_account", "receiver_address", "amount", "fee", "gas_limit", "nonce", "unsigned_hex_tx", "signed_hex_tx", "sent_hash_tx", "unsigned_updated_at", "sent_updated_at"}
	ethDetailTXColumnsWithoutDefault = []string{"tx_id", "uuid", "sender_account", "sender_address", "receiver_account", "receiver_address", "amount", "fee", "gas_limit", "nonce", "unsigned_hex_tx", "signed_hex_tx", "sent_hash_tx", "sent_updated_at"}
	ethDetailTXColumnsWithDefault    = []string{"id", "current_tx_type", "unsigned_updated_at"}
	ethDetailTXPrimaryKeyColumns     = []string{"id"}
	ethDetailTXGeneratedColumns      = []string{}
)

type (
	// EthDetailTXSlice is an alias for a slice of pointers to EthDetailTX.
	// This should almost always be used instead of []EthDetailTX.
