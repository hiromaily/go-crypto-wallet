...
func (e *Ethereum) NewAccount(passphrase string, accountType account.AccountType) (string, error) {
	...
	if err != nil {
		return "", errors.Wrap(err, "fail to call renameKeyFileWithAddress(address)")
	}
...
func (e *Ethereum) UnlockAccount(hexAddr, passphrase string, duration uint64) (bool, error) {
	...
	var ret bool
	err := e.rpcClient.CallContext(e.ctx, &ret, "personal_unlockAccount", hexAddr, passphrase, encodedDuration)
	if err != nil {
