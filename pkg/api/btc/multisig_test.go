...
func TestCreateMultiSig(t *testing.T) {
	...
	//TODO: Multisigアドレス作成
	resAddr, err := wlt.BTC.CreateMultiSig(2, []string{"2N7ZwUXpo841GZDpxLGFqrhr1xwMzTba7ZP", "2NAm558FWpiaJQLz838vbzBPpqmKxyeyxsu"}, "multi01", enum.AddressTypeLegacy)
	if err != nil {
		t.Fatal(err)
	}
	...
	resAddr, err = wlt.BTC.CreateMultiSig(2, []string{"2N7ZwUXpo841GZDpxLGFqrhr1xwMzTba7ZP", "2NAm558FWpiaJQLz838vbzBPpqmKxyeyxsu"}, "multi02", enum.AddressTypeP2shSegwit)
	if err != nil {
		t.Fatal(err)
	}
	t.Logf("multisig address: %s, redeemScript: %s", resAddr.Address, resAddr.RedeemScript)
