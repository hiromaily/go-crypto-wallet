...
func ExportAccountKeyTable(accountKeyTable []model.AccountKeyTable, strAccountType string, keyStatus uint8) (string, error) {
	//fileName
	fileName := CreateFilePath(strAccountType, keyStatus)
...
func ExportAddedPubkeyHistoryTable(addedPubkeyHistoryTable []model.AddedPubkeyHistoryTable, strAccountType string, keyStatus uint8) (string, error) {
	//fileName
	fileName := CreateFilePath(strAccountType, keyStatus)
