...
func (r *ColdRepository) getAllAccountKeyByKeyStatus(tbl string, keyStatus enum.KeyStatus) ([]AccountKeyTable, error) {
...
// GetAllAccountKeyByKeyStatus 指定したkeyStatusのレコードをすべて返す
func (r *ColdRepository) GetAllAccountKeyByKeyStatus(accountType account.AccountType, keyStatus enum.KeyStatus) ([]AccountKeyTable, error) {
...
func (r *ColdRepository) updateKeyStatusByWIF(tbl string, keyStatus enum.KeyStatus, strWIF string, tx *sqlx.Tx, isCommit bool) (int64, error) {
	sql := `
...
func (r *ColdRepository) UpdateKeyStatusByWIF(accountType account.AccountType, keyStatus enum.KeyStatus, strWIF string, tx *sqlx.Tx, isCommit bool) (int64, error) {
...
func (r *ColdRepository) updateKeyStatusByWIFs(tbl string, keyStatus enum.KeyStatus, wifs []string, tx *sqlx.Tx, isCommit bool) (int64, error) {
	var sql string
...
// UpdateKeyStatusByWIFs key_statusを更新する
func (r *ColdRepository) UpdateKeyStatusByWIFs(accountType account.AccountType, keyStatus enum.KeyStatus, wifs []string, tx *sqlx.Tx, isCommit bool) (int64, error) {
