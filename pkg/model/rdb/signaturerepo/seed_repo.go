...
func (r *SignatureRepository) GetSeedAll() ([]Seed, error) {
	var seeds []Seed
...
func (r *SignatureRepository) GetSeedOne() (Seed, error) {
	var seed Seed
...
func (r *SignatureRepository) GetSeedCount() (int64, error) {
	var count int64
...
func (r *SignatureRepository) InsertSeed(seed string, tx *sqlx.Tx, isCommit bool) (int64, error) {
