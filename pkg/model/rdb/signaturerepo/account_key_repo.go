...
func (r *SignatureRepository) getAllAccountKeyByKeyStatus(tbl string, keyStatus enum.KeyStatus) ([]AccountKeyTable, error) {
...
// GetAllAccountKeyByKeyStatus 指定したkeyStatusのレコードをすべて返す
func (r *SignatureRepository) GetAllAccountKeyByKeyStatus(accountType account.AccountType, keyStatus enum.KeyStatus) ([]AccountKeyTable, error) {
...
func (r *SignatureRepository) updateKeyStatusByWIF(tbl string, keyStatus enum.KeyStatus, strWIF string, tx *sqlx.Tx, isCommit bool) (int64, error) {
	sql := `
...
func (r *SignatureRepository) UpdateKeyStatusByWIF(accountType account.AccountType, keyStatus enum.KeyStatus, strWIF string, tx *sqlx.Tx, isCommit bool) (int64, error) {
...
func (r *SignatureRepository) updateKeyStatusByWIFs(tbl string, keyStatus enum.KeyStatus, wifs []string, tx *sqlx.Tx, isCommit bool) (int64, error) {
	var sql string
...
// UpdateKeyStatusByWIFs key_statusを更新する
func (r *SignatureRepository) UpdateKeyStatusByWIFs(accountType account.AccountType, keyStatus enum.KeyStatus, wifs []string, tx *sqlx.Tx, isCommit bool) (int64, error) {
