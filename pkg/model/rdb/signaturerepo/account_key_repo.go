...
func (r *SignatureRepository) getMaxIndexOnAccountKeyTable(tbl string) (int64, error) {
...
//GetMaxIndexOnAccountKeyTable indexの最大値を返す
func (r *SignatureRepository) GetMaxIndexOnAccountKeyTable(accountType account.AccountType) (int64, error) {
	return r.getMaxIndexOnAccountKeyTable(accountKeyTableName[accountType])
}

//getOneByMaxIDOnAccountKeyTable idが最大の1レコードを返す
func (r *SignatureRepository) getOneByMaxIDOnAccountKeyTable(tbl string, accountType account.AccountType) (*AccountKeyTable, error) {
...
//GetOneByMaxIDOnAccountKeyTable idが最大の1レコードを返す
func (r *SignatureRepository) GetOneByMaxIDOnAccountKeyTable(accountType account.AccountType) (*AccountKeyTable, error) {
...
func (r *SignatureRepository) getAllAccountKeyByKeyStatus(tbl string, keyStatus keystatus.KeyStatus) ([]AccountKeyTable, error) {
...
// GetAllAccountKeyByKeyStatus 指定したkeyStatusのレコードをすべて返す
func (r *SignatureRepository) GetAllAccountKeyByKeyStatus(accountType account.AccountType, keyStatus keystatus.KeyStatus) ([]AccountKeyTable, error) {
	return r.getAllAccountKeyByKeyStatus(accountKeyTableName[accountType], keyStatus)
}

func (r *SignatureRepository) getAllAccountKeyByMultiAddrs(tbl string, addrs []string) ([]AccountKeyTable, error) {
...
func (r *SignatureRepository) GetAllAccountKeyByMultiAddrs(accountType account.AccountType, addrs []string) ([]AccountKeyTable, error) {
...
func (r *SignatureRepository) insertAccountKeyTable(tbl string, accountKeyTables []AccountKeyTable, tx *sqlx.Tx, isCommit bool) error {
...
func (r *SignatureRepository) InsertAccountKeyTable(accountType account.AccountType, accountKeyTables []AccountKeyTable, tx *sqlx.Tx, isCommit bool) error {
...
func (r *SignatureRepository) updateKeyStatusByWIF(tbl string, keyStatus keystatus.KeyStatus, strWIF string, tx *sqlx.Tx, isCommit bool) (int64, error) {
	sql := `
...
func (r *SignatureRepository) UpdateKeyStatusByWIF(accountType account.AccountType, keyStatus keystatus.KeyStatus, strWIF string, tx *sqlx.Tx, isCommit bool) (int64, error) {
...
func (r *SignatureRepository) updateKeyStatusByWIFs(tbl string, keyStatus keystatus.KeyStatus, wifs []string, tx *sqlx.Tx, isCommit bool) (int64, error) {
	var sql string
...
// UpdateKeyStatusByWIFs key_statusを更新する
func (r *SignatureRepository) UpdateKeyStatusByWIFs(accountType account.AccountType, keyStatus keystatus.KeyStatus, wifs []string, tx *sqlx.Tx, isCommit bool) (int64, error) {
...
func (r *SignatureRepository) updateMultisigAddrOnAccountKeyTableByFullPubKey(tbl string, accountKeyTable []AccountKeyTable, tx *sqlx.Tx, isCommit bool) error {
	sql := `
...
// UpdateMultisigAddrOnAccountKeyTableByFullPubKey wallet_multisig_addressを更新する
func (r *SignatureRepository) UpdateMultisigAddrOnAccountKeyTableByFullPubKey(accountType account.AccountType, accountKeyTable []AccountKeyTable, tx *sqlx.Tx, isCommit bool) error {
