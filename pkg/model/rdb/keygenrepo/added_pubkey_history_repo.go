...
func (r *KeygenRepository) getAddedPubkeyHistoryTableByNoWalletMultisigAddress(tbl string, accountType account.AccountType) ([]AddedPubkeyHistoryTable, error) {
...
//GetAddedPubkeyHistoryTableByNoWalletMultisigAddress WalletMultisigAddressが発行されていないレコードを返す
func (r *KeygenRepository) GetAddedPubkeyHistoryTableByNoWalletMultisigAddress(accountType account.AccountType) ([]AddedPubkeyHistoryTable, error) {
...
func (r *KeygenRepository) getAddedPubkeyHistoryTableByNotExported(tbl string, accountType account.AccountType) ([]AddedPubkeyHistoryTable, error) {
...
func (r *KeygenRepository) GetAddedPubkeyHistoryTableByNotExported(accountType account.AccountType) ([]AddedPubkeyHistoryTable, error) {
...
func (r *KeygenRepository) insertAddedPubkeyHistoryTable(tbl string, addedPubkeyHistoryTables []AddedPubkeyHistoryTable, tx *sqlx.Tx, isCommit bool) error {
...
// InsertAddedPubkeyHistoryTable added_pubkey_history_table(payment, receipt...)テーブルにレコードを作成する
func (r *KeygenRepository) InsertAddedPubkeyHistoryTable(accountType account.AccountType, addedPubkeyHistoryTables []AddedPubkeyHistoryTable, tx *sqlx.Tx, isCommit bool) error {
...
func (r *KeygenRepository) updateMultisigAddrOnAddedPubkeyHistoryTable(tbl, multiSigAddr, redeemScript, authAddr1, fullPublicKey string, tx *sqlx.Tx, isCommit bool) error {
	sql := `
...
// UpdateMultisigAddrOnAddedPubkeyHistoryTable added_pubkey_history_table(payment, receipt...)テーブルのmultisigアドレスを更新する
func (r *KeygenRepository) UpdateMultisigAddrOnAddedPubkeyHistoryTable(accountType account.AccountType, multiSigAddr, redeemScript, authAddr1, fullPublicKey string, tx *sqlx.Tx, isCommit bool) error {
...
func (r *KeygenRepository) updateIsExportedOnAddedPubkeyHistoryTable(tbl string, ids []int64, tx *sqlx.Tx, isCommit bool) (int64, error) {
	var sql string
...
// UpdateIsExportedOnAddedPubkeyHistoryTable added_pubkey_history_table(payment, receipt...)テーブルのis_exportedを更新する
func (r *KeygenRepository) UpdateIsExportedOnAddedPubkeyHistoryTable(accountType account.AccountType, ids []int64, tx *sqlx.Tx, isCommit bool) (int64, error) {
