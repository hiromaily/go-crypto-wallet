...
func (r *KeygenRepository) getMaxIndexOnAccountKeyTable(tbl string) (int64, error) {
...
//GetMaxIndexOnAccountKeyTable indexの最大値を返す
func (r *KeygenRepository) GetMaxIndexOnAccountKeyTable(accountType account.AccountType) (int64, error) {
	return r.getMaxIndexOnAccountKeyTable(accountKeyTableName[accountType])
}

//getOneByMaxIDOnAccountKeyTable idが最大の1レコードを返す
func (r *KeygenRepository) getOneByMaxIDOnAccountKeyTable(tbl string, accountType account.AccountType) (*AccountKeyTable, error) {
...
//GetOneByMaxIDOnAccountKeyTable idが最大の1レコードを返す
func (r *KeygenRepository) GetOneByMaxIDOnAccountKeyTable(accountType account.AccountType) (*AccountKeyTable, error) {
...
func (r *KeygenRepository) getAllAccountKeyByMultiAddrs(tbl string, addrs []string) ([]AccountKeyTable, error) {
...
func (r *KeygenRepository) GetAllAccountKeyByMultiAddrs(accountType account.AccountType, addrs []string) ([]AccountKeyTable, error) {
...
func (r *KeygenRepository) insertAccountKeyTable(tbl string, accountKeyTables []AccountKeyTable, tx *sqlx.Tx, isCommit bool) error {
...
func (r *KeygenRepository) InsertAccountKeyTable(accountType account.AccountType, accountKeyTables []AccountKeyTable, tx *sqlx.Tx, isCommit bool) error {
...
func (r *KeygenRepository) updateMultisigAddrOnAccountKeyTableByFullPubKey(tbl string, accountKeyTable []AccountKeyTable, tx *sqlx.Tx, isCommit bool) error {
	sql := `
...
// UpdateMultisigAddrOnAccountKeyTableByFullPubKey wallet_multisig_addressを更新する
func (r *KeygenRepository) UpdateMultisigAddrOnAccountKeyTableByFullPubKey(accountType account.AccountType, accountKeyTable []AccountKeyTable, tx *sqlx.Tx, isCommit bool) error {
