...
See [Required Tools and Versions](../../template/docs/guidelines/requirements.md) for complete information about:
...
- **Compliance with coding standards**: Follow guidelines from `AGENTS.md` and [Coding Standards](../../template/docs/guidelines/coding-conventions.md)
...
See [Code Generation Guidelines](../../template/docs/guidelines/code-generation.md) for details.
...
- [Required Tools and Versions](../../template/docs/guidelines/requirements.md) - Tool requirements and version information
- [Core Principles](../../template/docs/guidelines/core.md) - Security and important notes
- [Code Generation Guidelines](../../template/docs/guidelines/code-generation.md) - Working with auto-generated files
- [Coding Standards](../../template/docs/guidelines/coding-conventions.md) - Linting and formatting commands
- [Testing Guidelines](../../template/docs/guidelines/testing.md) - Testing requirements and strategies
