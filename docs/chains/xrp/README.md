...
|----------|-------------|
| [testing-strategy.md](./testing-strategy.md) | CI/E2E node strategy, standalone mode rationale |
| [setup-docker-compose-standalone-xrpl.md](./setup-docker-compose-standalone-xrpl.md) | Docker Compose setup for local rippled |
| [transaction-flow.md](./transaction-flow.md) | XRP transaction flow details |
| [architecture-2026.md](./architecture-2026.md) | Current architecture overview |
| [xrpl-go.md](./xrpl-go.md) | xrpl-go library usage |
| [network-devnet.md](./network-devnet.md) | Devnet configuration |
