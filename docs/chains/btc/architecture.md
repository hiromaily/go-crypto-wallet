...
> - BTC protocol specifications: [docs/chains/btc/README.md](./README.md)
> - ETH reference implementation (single-sig comparison): [docs/chains/eth/architecture.md](../eth/architecture.md)
...
> See [docs/transaction-flow.md](../../transaction-flow.md) for the full single-sig vs multisig comparison.
