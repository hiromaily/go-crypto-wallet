...
|----------|------|---------|
| Core Principles | `agents/core.md` | エラーハンドリング、セキュリティ |
...
|-----------|----------|------|
| アーキテクチャ関連のバグ | Architecture | `agents/architecture.md` |
| データベース関連のバグ | Database | `agents/database.md` |
| 特定チェーン固有の問題 | Multi-Chain | `agents/multi-chain.md` |
| セキュリティ関連のバグ | Core (Security) | `agents/core.md` |
| テスト関連の問題 | Testing | `agents/testing.md` |
...
2. agents/core.md を読み込み（エラーハンドリング規約）
3. パニックが発生するコードパスを特定
4. 適切なエラーハンドリングを追加
5. テストを追加して回帰を防止
6. 検証コマンドを実行
...
- [Workflow Guidelines](../../../agents/workflow.md) - 検証ステップ詳細
- [Core Principles](../../../agents/core.md) - エラーハンドリング詳細
