...
Source: template/pages/docs/issues/REFACTORING_CHECKLIST.tpl.md · Run `make docs` to regenerate.
-->
...
- [x] Go version updated to 1.26.2
...
- [x] `go.mod` `go` directive updated to 1.26.2
