...
func testBasicCRUD(t *testing.T, repo *cold.NonceRepositorySqlc, ctx context.Context, data testData) {
	t.Helper()
...
func testMultipleSigners(t *testing.T, repo *cold.NonceRepositorySqlc, ctx context.Context, data testData) {
	t.Helper()
...
func testMarkingOperations(t *testing.T, repo *cold.NonceRepositorySqlc, ctx context.Context, data testData) {
	t.Helper()
...
func testCleanupOperations(t *testing.T, repo *cold.NonceRepositorySqlc, ctx context.Context, data testData) {
	t.Helper()
...
func testDeleteOperations(t *testing.T, repo *cold.NonceRepositorySqlc, ctx context.Context, data testData) {
	t.Helper()
