...
const insertBtcTxInput = `-- name: InsertBtcTxInput :one
...
func (q *Queries) InsertBtcTxInput(ctx context.Context, arg InsertBtcTxInputParams) (int64, error) {
	row := q.db.QueryRowContext(ctx, insertBtcTxInput,
		arg.TxID,
		arg.InputTxid,
		arg.InputVout,
		arg.InputAddress,
