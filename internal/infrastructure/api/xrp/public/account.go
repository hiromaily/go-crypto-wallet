...
func (p *PublicXRP) GetAccountInfo(ctx context.Context, address string) (*xrplgo.AccountInfo, error) {
	if address == "" {
...
// fromWSAccountInfo converts a WebSocket ResponseAccountInfo to the xrplgo AccountInfo type.
