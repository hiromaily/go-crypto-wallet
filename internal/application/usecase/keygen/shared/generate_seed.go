...
func NewGenerateSeedUseCase(seedRepo persistence.SeedRepositorier) keygenusecase.GenerateSeedUseCase {
...
func (u *generateSeedUseCase) Generate(ctx context.Context) (keygenusecase.GenerateSeedOutput, error) {
	...
	if err != nil {
		return keygenusecase.GenerateSeedOutput{}, fmt.Errorf("fail to call infraKey.GenerateSeed(): %w", err)
	}
...
func (u *generateSeedUseCase) Store(
	...
	if err != nil {
		return keygenusecase.StoreSeedOutput{}, fmt.Errorf("fail to call infraKey.SeedToByte(): %w", err)
	}
