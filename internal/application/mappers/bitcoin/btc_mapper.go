...
func ToAddressInfo(result *btc.GetAddressInfoResult) *bitcoindto.AddressInfo {
	if result == nil {
		return nil
	}
...
func ToValidateAddressResult(result *btc.ValidateAddressResult) *bitcoindto.ValidateAddressResult {
	if result == nil {
		return nil
	}
...
func ToNetworkInfo(result *btc.GetNetworkInfoResult) *bitcoindto.NetworkInfo {
	if result == nil {
		return nil
	}
...
func ToBlockchainInfo(result *btc.GetBlockchainInfoResult) *bitcoindto.BlockchainInfo {
	if result == nil {
		return nil
	}
