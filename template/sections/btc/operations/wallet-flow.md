...
- Transaction files use **PSBT (Partially Signed Bitcoin Transaction)** format — see [psbt/](../../../../docs/chains/btc/psbt/README)
- Bitcoin Core descriptor wallets are used for address management — see [descriptor/](../../../../docs/chains/btc/descriptor/README)
