...
- [Required Tools and Versions](../../../docs/guidelines/requirements.md) - Tool requirements and version information
- [Core Principles](../../../docs/guidelines/core.md) - Security and important notes
- [Code Generation Guidelines](../../../docs/guidelines/code-generation.md) - Working with auto-generated files
- [Coding Standards](../../../docs/guidelines/coding-conventions.md) - Linting and formatting commands
- [Testing Guidelines](../../../docs/guidelines/testing.md) - Testing requirements and strategies
