...
- [Core Principles](../../../docs/guidelines/core.md) - Error handling, panic usage, and core patterns
- [Testing Guidelines](../../../docs/guidelines/testing.md) - Comprehensive testing strategy
