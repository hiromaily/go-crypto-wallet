...
- [Architecture Guidelines](../../../docs/guidelines/architecture.md) - Layer structure and organization
- [Code Generation Guidelines](../../../docs/guidelines/code-generation.md) - Protocol buffer generation for XRP
- [Testing Guidelines](../../../docs/guidelines/testing.md) - Testing multi-chain implementations
