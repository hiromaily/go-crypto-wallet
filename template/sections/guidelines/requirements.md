...
- **Installation**: See [Coding Standards](../../../docs/guidelines/coding-conventions.md)
...
- **Usage**: Database schema management and migrations (see [Database Management](../../../docs/database/architecture.md))
...
- [Workflow Guidelines](../../../docs/guidelines/workflow.md) - Development workflow and common steps
- [Database Management](../../../docs/database/architecture.md) - Atlas usage for database migrations
- [Coding Standards](../../../docs/guidelines/coding-conventions.md) - golangci-lint configuration and usage
