...
**For detailed schema change workflows, see [Database Schema Changes Guide](../../../docs/database/schema-changes.md)**

### Supported Databases

See [Database Architecture](../../../docs/database/architecture.md) for the full list of supported backends, schema design, and setup instructions.
...
**For complete step-by-step workflow with examples, see [Database Schema Changes Guide](../../../docs/database/schema-changes.md)**
...
See [Database Schema Changes Guide](../../../docs/database/schema-changes.md) for complete mapping table.
...
See [Code Generation Guide](../../../docs/guidelines/code-generation.md) for full Atlas workflow and commands.

### SQLC Schema Files (from Database Dumps)

See [Code Generation Guide](../../../docs/guidelines/code-generation.md) for the full schema extraction process.

### Database Code (SQLC)

See [Code Generation Guide](../../../docs/guidelines/code-generation.md) for SQLC configuration and generation commands.
...
- [Code Generation Guidelines](../../../docs/guidelines/code-generation.md) - Complete overview of all code generation tools
- [Architecture Guidelines](../../../docs/database/architecture.md) - Infrastructure layer guidelines for repositories
- [Workflow Guidelines](../../../docs/guidelines/workflow.md) - Dependency management and verification commands
