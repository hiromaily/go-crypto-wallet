...
- **Complete Workflow**: [Database Schema Changes Guide](../../../docs/database/schema-changes.md)
- **Database Architecture**: [Development Database Docs](../../../docs/database/architecture.md)
- **Atlas Details**: `tools/atlas/README.md`
- **Code Generation**: [Code Generation Guidelines](../../../docs/guidelines/code-generation.md)
