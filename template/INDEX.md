...
| pages/docs/guidelines/coding-conventions.tpl.md | docs/guidelines/coding-conventions.md | 1 |
| pages/docs/guidelines/testing.tpl.md | docs/guidelines/testing.md | 1 |
| pages/docs/guidelines/workflow.tpl.md | docs/guidelines/workflow.md | 1 |
...
| pages/docs/guidelines/multi-chain.tpl.md | docs/guidelines/multi-chain.md | 1 |
| pages/docs/guidelines/code-generation.tpl.md | docs/guidelines/code-generation.md | 1 |
| pages/docs/guidelines/release.tpl.md | docs/guidelines/release.md | 1 |
...
| pages/docs/guidelines/claude-mem.tpl.md | docs/guidelines/claude-mem.md | 1 |
| pages/docs/database/architecture.tpl.md | docs/database/architecture.md | 1 |
| pages/docs/database/db-management.tpl.md | docs/database/db-management.md | 1 |
| pages/docs/database/schema-changes.tpl.md | docs/database/schema-changes.md | 1 |
...
| sections/architecture/architecture-overview.md | ARCHITECTURE |
| sections/architecture/architecture.md | README |
| sections/architecture/components.md | README |
| sections/architecture/data-flow.md | ARCHITECTURE |
| sections/architecture/dependency-injection.md | ARCHITECTURE |
| sections/architecture/design-philosophy.md | ARCHITECTURE |
| sections/architecture/directory-structure.md | README |
...
| sections/database/quick-reference.md | quick-reference |
| sections/database/schema-changes.md | schema-changes |
| sections/database/sqlc-code-generation-flow.md | sqlc-code-generation-flow |
...
| sections/guidelines/claude-mem.md | claude-mem |
| sections/guidelines/code-generation.md | code-generation |
| sections/guidelines/coding-conventions.md | coding-conventions |
| sections/guidelines/core.md | core |
| sections/guidelines/multi-chain.md | multi-chain |
| sections/guidelines/overview.md | README |
| sections/guidelines/release.md | release |
...
| sections/guidelines/testing.md | testing |
| sections/guidelines/workflow.md | workflow |
...
| sections/project/installation.md | installation |
