...
| pages/docs/guidelines/overview.tpl.md | docs/guidelines/README.md | 1 |
| pages/docs/guidelines/architecture.tpl.md | docs/guidelines/architecture.md | 1 |
| pages/docs/guidelines/coding-conventions.tpl.md | docs/guidelines/coding-conventions.md | 10 |
| pages/docs/guidelines/testing.tpl.md | docs/guidelines/testing.md | 10 |
| pages/docs/guidelines/workflow.tpl.md | docs/guidelines/workflow.md | 9 |
| pages/docs/guidelines/security.tpl.md | docs/guidelines/security.md | 1 |
| pages/docs/guidelines/core.tpl.md | docs/guidelines/core.md | 1 |
| pages/docs/guidelines/multi-chain.tpl.md | docs/guidelines/multi-chain.md | 7 |
| pages/docs/guidelines/code-generation.tpl.md | docs/guidelines/code-generation.md | 13 |
| pages/docs/guidelines/release.tpl.md | docs/guidelines/release.md | 9 |
| pages/docs/guidelines/requirements.tpl.md | docs/guidelines/requirements.md | 1 |
| pages/docs/guidelines/task-classification.tpl.md | docs/guidelines/task-classification.md | 1 |
| pages/docs/guidelines/claude-mem.tpl.md | docs/guidelines/claude-mem.md | 9 |
| pages/docs/database/architecture.tpl.md | docs/database/architecture.md | 13 |
| pages/docs/database/db-management.tpl.md | docs/database/db-management.md | 1 |
| pages/docs/database/schema-changes.tpl.md | docs/database/schema-changes.md | 11 |
| pages/docs/database/quick-reference.tpl.md | docs/database/quick-reference.md | 11 |
| pages/docs/database/atlas-migration-flow.tpl.md | docs/database/atlas-migration-flow.md | 8 |
| pages/docs/database/sqlc-code-generation-flow.tpl.md | docs/database/sqlc-code-generation-flow.md | 7 |
| pages/docs/architecture/index.tpl.md | docs/architecture/index.md | 3 |
| pages/docs/architecture/design-philosophy.tpl.md | docs/architecture/design-philosophy.md | 1 |
| pages/docs/architecture/layers.tpl.md | docs/architecture/layers.md | 2 |
| pages/docs/architecture/wallet-architecture.tpl.md | docs/architecture/wallet-architecture.md | 1 |
| pages/docs/architecture/dependency-injection.tpl.md | docs/architecture/dependency-injection.md | 1 |
...
| sections/chains/bch/interface-separation.md | interface-separation |
| sections/chains/btc/architecture.md | architecture |
| sections/chains/btc/archive/README.md | README |
| sections/chains/btc/archive/operation-example.md | operation-example |
| sections/chains/btc/descriptor/README.md | README |
| sections/chains/btc/descriptor/api.md | api |
| sections/chains/btc/descriptor/architecture.md | architecture |
| sections/chains/btc/descriptor/compatibility.md | compatibility |
| sections/chains/btc/descriptor/development.md | development |
| sections/chains/btc/descriptor/examples.md | examples |
| sections/chains/btc/descriptor/migration.md | migration |
| sections/chains/btc/descriptor/user-guide.md | user-guide |
| sections/chains/btc/keygen/README.md | README |
| sections/chains/btc/keygen/improvements-2025-ja.md | improvements-2025-ja |
| sections/chains/btc/keygen/improvements-2025.md | improvements-2025 |
| sections/chains/btc/keygen/interface-design.md | interface-design |
| sections/chains/btc/musig2/README.md | README |
| sections/chains/btc/operations/README.md | README |
| sections/chains/btc/operations/pattern3-verification.md | pattern3-verification |
| sections/chains/btc/operations/wallet-flow-improvements-2025.md | wallet-flow-improvements-2025 |
| sections/chains/btc/operations/wallet-flow.md | wallet-flow |
| sections/chains/btc/overview/README.md | README |
| sections/chains/btc/overview/address-types.md | address-types |
| sections/chains/btc/overview/technical-reference.md | technical-reference |
| sections/chains/btc/psbt/README.md | README |
| sections/chains/btc/psbt/poc-example.md | poc-example |
| sections/chains/btc/taproot/README.md | README |
| sections/chains/btc/taproot/testing.md | testing |
| sections/chains/btc/taproot/user-guide.md | user-guide |
| sections/chains/eth/architecture.md | architecture |
| sections/chains/eth/json-schema.md | json-schema |
| sections/chains/eth/multisig.md | multisig |
| sections/chains/eth/solidity-development.md | solidity-development |
| sections/chains/eth/transaction-patterns.md | transaction-patterns |
| sections/chains/xrp/README.md | README |
| sections/chains/xrp/architecture-2026.md | architecture-2026 |
| sections/chains/xrp/architecture-xrpl-grpc-server-version.md | architecture-xrpl-grpc-server-version |
| sections/chains/xrp/library-selection.md | library-selection |
| sections/chains/xrp/network-devnet.md | network-devnet |
| sections/chains/xrp/setup-docker-compose-standalone-xrpl.md | setup-docker-compose-standalone-xrpl |
| sections/chains/xrp/testing-strategy.md | testing-strategy |
| sections/chains/xrp/transaction-flow.md | transaction-flow |
| sections/chains/xrp/xrpl-go.md | xrpl-go |
...
| sections/database/architecture/management.md | architecture |
| sections/database/architecture/migration-guide.md | architecture |
| sections/database/architecture/overview.md | architecture |
| sections/database/architecture/references.md | architecture |
| sections/database/architecture/schema-design.md | architecture |
| sections/database/architecture/setup-configuration.md | architecture |
| sections/database/architecture/sqlc-codegen.md | architecture |
| sections/database/architecture/sqlite-e2e.md | architecture |
| sections/database/architecture/supported-databases.md | architecture |
| sections/database/architecture/troubleshooting.md | architecture |
| sections/database/atlas-migration-flow/destructive-changes.md | atlas-migration-flow |
| sections/database/atlas-migration-flow/dev-vs-production.md | atlas-migration-flow |
| sections/database/atlas-migration-flow/dialect-differences.md | atlas-migration-flow |
| sections/database/atlas-migration-flow/environments.md | atlas-migration-flow |
| sections/database/atlas-migration-flow/initial-setup.md | atlas-migration-flow |
| sections/database/atlas-migration-flow/makefile-targets.md | atlas-migration-flow |
| sections/database/atlas-migration-flow/overview.md | atlas-migration-flow |
| sections/database/atlas-migration-flow/schema-change.md | atlas-migration-flow |
| sections/database/db-management.md | db-management |
| sections/database/quick-reference/common-mistakes.md | quick-reference |
| sections/database/quick-reference/data-types.md | quick-reference |
| sections/database/quick-reference/db-configuration.md | quick-reference |
| sections/database/quick-reference/docs-links.md | quick-reference |
| sections/database/quick-reference/file-locations.md | quick-reference |
| sections/database/quick-reference/make-commands.md | quick-reference |
| sections/database/quick-reference/overview.md | quick-reference |
| sections/database/quick-reference/sql-queries.md | quick-reference |
| sections/database/quick-reference/testing.md | quick-reference |
| sections/database/quick-reference/troubleshooting.md | quick-reference |
| sections/database/quick-reference/workflows.md | quick-reference |
| sections/database/schema-changes/best-practices.md | schema-changes |
| sections/database/schema-changes/common-patterns.md | schema-changes |
| sections/database/schema-changes/multi-database.md | schema-changes |
| sections/database/schema-changes/overview.md | schema-changes |
| sections/database/schema-changes/quick-reference.md | schema-changes |
| sections/database/schema-changes/resources.md | schema-changes |
| sections/database/schema-changes/testing.md | schema-changes |
| sections/database/schema-changes/troubleshooting.md | schema-changes |
| sections/database/schema-changes/workflow-add-column.md | schema-changes |
| sections/database/schema-changes/workflow-add-table.md | schema-changes |
| sections/database/schema-changes/workflow-modify-column.md | schema-changes |
| sections/database/sqlc-code-generation-flow/actual-commands.md | sqlc-code-generation-flow |
| sections/database/sqlc-code-generation-flow/config-summary.md | sqlc-code-generation-flow |
| sections/database/sqlc-code-generation-flow/flowchart.md | sqlc-code-generation-flow |
| sections/database/sqlc-code-generation-flow/full-regen.md | sqlc-code-generation-flow |
...
| sections/guidelines/claude-mem/installation.md | claude-mem |
| sections/guidelines/claude-mem/overview.md | claude-mem |
| sections/guidelines/claude-mem/patterns.md | claude-mem |
| sections/guidelines/claude-mem/see-also.md | claude-mem |
| sections/guidelines/claude-mem/troubleshooting.md | claude-mem |
| sections/guidelines/claude-mem/usage.md | claude-mem |
| sections/guidelines/code-generation/atlas.md | code-generation |
| sections/guidelines/code-generation/lock-files.md | code-generation |
| sections/guidelines/code-generation/mockery.md | code-generation |
| sections/guidelines/code-generation/overview.md | code-generation |
| sections/guidelines/code-generation/protobuf-go.md | code-generation |
| sections/guidelines/code-generation/protobuf-ts.md | code-generation |
| sections/guidelines/code-generation/quick-reference.md | code-generation |
| sections/guidelines/code-generation/rules.md | code-generation |
| sections/guidelines/code-generation/see-also.md | code-generation |
| sections/guidelines/code-generation/smart-contracts.md | code-generation |
| sections/guidelines/code-generation/sqlc-code.md | code-generation |
| sections/guidelines/code-generation/sqlc-schemas.md | code-generation |
| sections/guidelines/code-generation/web-build.md | code-generation |
| sections/guidelines/coding-conventions/code-style.md | coding-conventions |
| sections/guidelines/coding-conventions/commands.md | coding-conventions |
| sections/guidelines/coding-conventions/imports.md | coding-conventions |
| sections/guidelines/coding-conventions/linter-guidelines.md | coding-conventions |
| sections/guidelines/coding-conventions/linting.md | coding-conventions |
| sections/guidelines/coding-conventions/naming.md | coding-conventions |
| sections/guidelines/coding-conventions/overview.md | coding-conventions |
| sections/guidelines/coding-conventions/quick-verification.md | coding-conventions |
...
| sections/guidelines/multi-chain/considerations.md | multi-chain |
| sections/guidelines/multi-chain/overview.md | multi-chain |
| sections/guidelines/multi-chain/see-also.md | multi-chain |
| sections/guidelines/multi-chain/wallet-types.md | multi-chain |
| sections/guidelines/overview.md | README |
| sections/guidelines/release/artifacts.md | release |
| sections/guidelines/release/changelog.md | release |
| sections/guidelines/release/config.md | release |
| sections/guidelines/release/detailed-process.md | release |
| sections/guidelines/release/local-testing.md | release |
| sections/guidelines/release/makefile.md | release |
| sections/guidelines/release/overview.md | release |
| sections/guidelines/release/see-also.md | release |
| sections/guidelines/release/troubleshooting.md | release |
| sections/guidelines/requirements.md | requirements |
| sections/guidelines/security.md | security |
| sections/guidelines/task-classification.md | task-classification |
| sections/guidelines/testing/best-practices.md | testing |
| sections/guidelines/testing/by-layer.md | testing |
| sections/guidelines/testing/coverage.md | testing |
| sections/guidelines/testing/mockery.md | testing |
| sections/guidelines/testing/organization.md | testing |
| sections/guidelines/testing/overview.md | testing |
| sections/guidelines/testing/running.md | testing |
| sections/guidelines/testing/table-driven.md | testing |
| sections/guidelines/testing/testify.md | testing |
| sections/guidelines/testing/utilities.md | testing |
| sections/guidelines/workflow/branching.md | workflow |
| sections/guidelines/workflow/common-steps.md | workflow |
| sections/guidelines/workflow/dependency-management.md | workflow |
| sections/guidelines/workflow/git-operations.md | workflow |
| sections/guidelines/workflow/important-notes.md | workflow |
| sections/guidelines/workflow/overview.md | workflow |
...
| sections/misc/bch/address-types-key-derivation-2.md | README |
| sections/misc/bch/details-of-each-pattern-for-bch.md | e2e-transaction-patterns |
| sections/misc/bch/differences-from-bitcoin.md | README |
| sections/misc/bch/e2e-transaction-patterns.md | README |
| sections/misc/bch/fee-management-2.md | README |
...
| sections/misc/btc/4-data-flow.md | implementation |
| sections/misc/btc/5-migration-strategy.md | implementation |
| sections/misc/btc/6-validation-offline-wallet-requirements.md | implementation |
| sections/misc/btc/7-risk-assessment-and-mitigation.md | implementation |
| sections/misc/btc/9-success-criteria.md | implementation |
| sections/misc/btc/account-types-and-signing-requirements.md | e2e-transaction-patterns |
| sections/misc/btc/adding-new-features.md | developer-guide |
| sections/misc/btc/additional-resources-2.md | developer-guide |
| sections/misc/btc/additional-resources.md | user-guide |
| sections/misc/btc/address-creation.md | user-guide |
| sections/misc/btc/address-types-key-derivation.md | README |
| sections/misc/btc/address-types.md | user-guide |
| sections/misc/btc/appendices.md | migration |
| sections/misc/btc/appendix-attack-scenarios.md | security |
| sections/misc/btc/best-practices-2.md | user-guide |
| sections/misc/btc/best-practices.md | user-guide |
| sections/misc/btc/coexistence-strategy.md | migration-from-traditional |
| sections/misc/btc/compatibility-considerations.md | migration-from-traditional |
| sections/misc/btc/component-interactions.md | architecture |
| sections/misc/btc/conclusion-2.md | migration-from-traditional |
| sections/misc/btc/conclusion.md | security |
| sections/misc/btc/data-flow.md | architecture |
| sections/misc/btc/database-schema.md | architecture |
| sections/misc/btc/debugging.md | developer-guide |
| sections/misc/btc/details-of-each-pattern-for-btc.md | e2e-transaction-patterns |
| sections/misc/btc/documentation-structure.md | README |
| sections/misc/btc/e2e-transaction-patterns-guide.md | e2e-transaction-patterns |
| sections/misc/btc/e2e-workflow-matrix.md | e2e-transaction-patterns |
| sections/misc/btc/executive-summary.md | implementation |
| sections/misc/btc/fee-management.md | README |
| sections/misc/btc/file-management-2.md | user-guide |
| sections/misc/btc/file-management.md | user-guide |
| sections/misc/btc/glossary-2.md | user-guide |
| sections/misc/btc/glossary.md | user-guide |
| sections/misc/btc/implementation-notes.md | architecture |
| sections/misc/btc/implementation-status.md | e2e-transaction-patterns |
| sections/misc/btc/key-security.md | security |
| sections/misc/btc/migration-from-traditional-multisig.md | architecture |
| sections/misc/btc/migration-guide-traditional-multisig-to-musig2.md | migration-from-traditional |
| sections/misc/btc/migration-process-2.md | migration |
| sections/misc/btc/migration-process.md | migration-from-traditional |
| sections/misc/btc/migration-support.md | migration |
| sections/misc/btc/migration-timeline.md | migration |
| sections/misc/btc/multisig-musig2.md | README |
| sections/misc/btc/musig2-basics.md | user-guide |
| sections/misc/btc/musig2-security-documentation.md | security |
| sections/misc/btc/musig2-user-guide.md | user-guide |
| sections/misc/btc/network-consensus.md | README |
| sections/misc/btc/nonce-security.md | security |
| sections/misc/btc/operational-security.md | security |
| sections/misc/btc/performance-comparison.md | user-guide |
| sections/misc/btc/performance-considerations-2.md | developer-guide |
| sections/misc/btc/performance-considerations.md | architecture |
| sections/misc/btc/post-migration-verification.md | migration |
| sections/misc/btc/pre-migration-preparation.md | migration |
| sections/misc/btc/project-documentation.md | README |
| sections/misc/btc/psbt-basics.md | user-guide |
| sections/misc/btc/psbt-developer-guide.md | developer-guide |
...
| sections/misc/btc/rollback-procedure.md | migration |
| sections/misc/btc/rollback-procedures.md | migration-from-traditional |
| sections/misc/btc/security-checklist.md | security |
| sections/misc/btc/security-considerations.md | README |
| sections/misc/btc/should-you-migrate.md | migration-from-traditional |
| sections/misc/btc/signature-patterns.md | e2e-transaction-patterns |
| sections/misc/btc/signing-mechanisms.md | README |
| sections/misc/btc/supported-key-types.md | e2e-transaction-patterns |
| sections/misc/btc/table-of-contents-4.md | security |
...
| sections/misc/devcontainer/development-workflow.md | devcontainer |
| sections/misc/devcontainer/features.md | devcontainer |
| sections/misc/devcontainer/table-of-contents-9.md | devcontainer |
| sections/misc/devcontainer/using-with-ai-tools.md | devcontainer |
| sections/misc/devcontainer/why-devcontainer.md | devcontainer |
| sections/misc/eth/address-types-key-derivation-3.md | README |
| sections/misc/eth/erc-20-token-support.md | README |
| sections/misc/eth/fee-management-3.md | README |
| sections/misc/eth/network-confirmation-guidelines.md | README |
| sections/misc/eth/security-considerations-3.md | README |
| sections/misc/eth/signing-mechanism.md | README |
| sections/misc/eth/transaction-types.md | README |
| sections/misc/eth/wallet-implementation-3.md | README |
