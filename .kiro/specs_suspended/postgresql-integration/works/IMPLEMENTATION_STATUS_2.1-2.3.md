...
- Added three PostgreSQL local development environments:
  - `local_postgres_watch` - Watch wallet schema
  - `local_postgres_keygen` - Keygen wallet schema
  - `local_postgres_sign` - Sign wallet schema
...
- Migration directories: `file://migrations/postgres_{watch|keygen|sign}`
...
- ✅ Created migration directories:
  - `tools/atlas/migrations/postgres/watch/`
  - `tools/atlas/migrations/postgres/keygen/`
  - `tools/atlas/migrations/postgres/sign/`
...
# Apply migrations
atlas migrate apply --env local_postgres_watch
atlas migrate apply --env local_postgres_keygen
atlas migrate apply --env local_postgres_sign

# Verify schema matches HCL
atlas schema diff --env local_postgres_watch  # Should show "Schemas are synced"
```
...
- `.kiro/specs/postgres-integration/tasks.md` (updated checkboxes and status)

### Created Directories

- `tools/atlas/migrations/postgres/watch/` with README.md (1.4KB)
- `tools/atlas/migrations/postgres/keygen/` with README.md (1.1KB)
- `tools/atlas/migrations/postgres/sign/` with README.md (1.1KB)
...
- [Atlas Migration README](../../../tools/atlas/migrations/postgres/watch/README.md)
