...
- [ ] 3. (P) Replace XRP watch manual mocks with generated mocks

- [ ] 3.1 (P) Replace the transaction-submitter mock in the send-transaction test file
...
- [ ] 3.2 (P) Replace the account-info and transaction-preparer mocks in the create-transaction test file
...
- [ ] 3.3 Verify XRP watch tests pass after mock replacement
  - Run `make gotest` scoped to the XRP watch use case package
  - Confirm every test case passes and no new failures are introduced by the mock replacements
  - _Requirements: 2.5_

- [ ] 4. (P) Create the Claude mockery skill

- [ ] 4.1 (P) Write the mockery skill file at `.claude/skills/mockery/SKILL.md`
...
- [ ] 5. Finalize convention rule and run full verification

- [ ] 5.1 Confirm the mock placement convention rule aligns with the final configuration
...
- [ ] 5.2 Run complete build and test verification across all changed areas
