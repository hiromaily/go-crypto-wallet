...
- [ ] 1.1 (P) Set up the ETH RPC package foundation with client interfaces
...
- [ ] 1.2 (P) Move gas estimation and core ETH blockchain query functions
...
- [ ] 1.3 (P) Move ETH transaction and node management RPC functions
...
- [ ]* 1.4 Add unit tests for the ETH RPC package
...
- [ ] 2.1 (P) Set up the XRP RPC package foundation with WebSocket client interface
...
- [ ] 2.2 (P) Move XRP public node query functions and their wire types
...
- [ ] 2.3 (P) Move XRP admin key generation functions and their wire types
...
- [ ]* 2.4 Add unit tests for the XRP RPC package
...
- [ ] 3.1 Set up the BTC RPC package foundation with client interface
...
- [ ] 3.2 (P) Implement address and validation RPC functions with wire types
...
- [ ] 3.3 (P) Implement network and blockchain info RPC functions with wire types
...
- [ ] 3.4 (P) Implement transaction RPC functions with wire types
...
- [ ] 3.5 (P) Implement import, descriptor, wallet, and utility RPC functions with wire types
...
- [ ]* 3.6 Add unit tests for the BTC RPC package
...
- [ ] 4.1 (P) Thin out the ETH infrastructure adapter
...
- [ ] 4.2 (P) Thin out the XRP infrastructure adapter
...
- [ ] 4.3 Update the BTC infrastructure adapter to delegate to the BTC RPC package
...
- [ ] 4.4 Verify Phase 1 correctness across all chains
